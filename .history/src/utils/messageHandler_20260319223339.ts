import type { Message, UpdateCallback, FileItem } from '@/types'
...
export const messageHandler = {
  ...
  handleNormalResponse(response: { choices: Array<{ message: { content: string; reasoning_content?: string } }>; usage: { completion_tokens: number }; speed: string }, updateCallback: UpdateCallback) {
    updateCallback(
  ...
  async handleResponse(response: Response | { choices: Array<{ message: { content: string; reasoning_content?: string } }>; usage: { completion_tokens: number }; speed: string }, isStream: boolean, updateCallback: UpdateCallback) {
    if (isStream) {
