...
function ChatView() {
  ...
  }, [currentMessages, chatStore.isLoading, scrollToBottom, chatStore.conversations.length])
  ...
  const handleSend = useCallback(async (messageContent: { text: string; files: FileItem[] }) => {
    try {
  ...
  return (
    <div className="chat-container">
      ...
      <SettingsPanel ref={settingDrawerRef as React.RefObject<{ openDrawer: () => void }> | null} />
      <DialogEdit ref={dialogEditRef as React.RefObject<{ openDialog: (conversationId: string, type: 'edit' | 'delete') => void }> | null} />
    </div>
  )
}
